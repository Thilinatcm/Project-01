        ...
        axios.get(`http://localhost:8000/item/${id}`).then((res)=>{
            if(res.data.success){
                this.setState({
                    ...
                    item_code:res.data.item.item_code,
                    item_name:res.data.item.item_name,
                    unit:res.data.item.unit,
                    category:res.data.item.category,
                    reorder_level:res.data.item.reorder_level
                });
                  ...
                  <div className='row'>
                      ...
                      <form>
                            ...
                            <input type='text' name='reorder_level' placeholder='Enter Reorder Level' className="form-control" value={this.state.reorder_level} onChange={this.handleInputChange}></input>
                              ...
                              <button type='submit' className='btn btn-success mt-2' onClick={this.onSubmint}>Update</button>
